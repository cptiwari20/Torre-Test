...
export default ({ getResults }) => {
  ...
  return (
    <div className={results.length !== 0 ? "section-container-left" : "section-container-center"}>
      <div className="section-search">
        <h1 className="heading-main fw-bold">Find Jobs & People.</h1>
        <input onChange={(e) => handleValueChange(e.target.value, "string")} className="input-element search-input" type="text" placeholder="Enter the search term" />
        <select onChange={(e) => handleValueChange(e.target.value, "type")} className="input-element">
